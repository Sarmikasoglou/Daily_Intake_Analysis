...
- In the Body Weights tab, the uploaded workbook should contain `EID`, `Date`, and `Weight (Kg)`. The weight-file `EID` is matched to the lookup-file `EID`, and the displayed cow identifier is the lookup-file `EART`.
